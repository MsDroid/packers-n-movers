      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <p class="para-1">List of old and used household effects of Mr./Mrs. : &nbsp; 
            ...
            <select class="bdr-none" style="width: auto;" name="from-add" id="site_address">
            ...
            vide their 
            Consignment Note No 
            <input type="text" id="note-no" value="" class="bdr-none" placeholder="Consignment No.">
            dated 
            <input type="date" value="" id="on-date" class="bdr-none" required>
            Contact No. 
            <input type="number" value="" id="contact" class="bdr-none" required>
            Email <input type="email" id="email" class="bdr-none" required style="width: 20%;">
          </p>
        ...
        <div class="row">
          <div class="col-3 pt40">
            <div  class="left-side" style="text-align: center;">
              ...
              <input type="hidden" name="" id="partySignImg">
              <span>
...
// update functions
      function updateMyForm() {
        ...
        if (oaddress != '' && faddress != '' && name != '' & fromAdd != '' & toAdd != '' & cNoteNo != '' & date != '') {
              let arr = [];
            ...
            var dataString = 'email='+ email + '&name=' + name + '&fromAdd=' + fromAdd + '&toAdd=' + toAdd + '&cNoteNo=' + cNoteNo + '&date=' + date + '&id=' + id  + '&data=' + myjsondata + '&contact=' + contact + '&oaddress=' + oaddress + '&faddress=' + faddress + '&psign=' + psign + '&osign=' + osign;

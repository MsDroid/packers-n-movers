...
let osign = document.getElementById('officeSignImg').value;
           ...
           let dataString = 'psign=' + psign + '&osign=' + osign + '&name=' + name + '&fromadd=' + fromadd + '&toadd=' + toadd + '&mob=' + mob + '&ccrjson=' + ccrjson + '&ccrradios_json=' + ccrradios_json + '&ccrremarkjson=' + ccrremarkjson + '&m_no=' + m_no;
...
//update
//================================================
function updateCarConditionReport(){
let name = document.getElementById('name').value;
        let add = document.getElementById('address').value;
        let add1 = document.getElementById('address-1').value;
        let mob = document.getElementById('contact-no').value;

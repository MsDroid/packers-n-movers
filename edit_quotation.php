          ...
          <form id="billForm">
            <div class="row">
              ...
              <div class="col-4 pd-l70">
               ...
               <div class="dflex">
                 <h6>No. :</h6>
                 <h6><input class="bdr-none" disabled id="no" value="<?php ?>" type="text" name="no"></h6>
               </div>
               <div class="dflex">
                 <h6>Date :</h6>
            ...
            <div class="row">
              <div class="col-7 comments">
                ...
                <div class="dflex">
                  ...
                  <h6 class="w100p">
                    <input type="text" class="bdr-none w100p" id="packing_date_no" placeholder="">
                  </h6>
                </div>
                ...
                <div class="dflex">
                 ...
                 <div class="dflex">
                  ...
                  <h6 class="w100p">
                    <input type="date" class="bdr-none w100p" id="loading_date">
                  </h6>
                </div>
                ...
                <div class="dflex">
                  ...
                  <span>
                    <input type="radio" value="Yes" id="Yes" name="noentry_checked">&nbsp;Yes&nbsp;
                    <input type="radio" value="No" id="No" name="noentry_checked">&nbsp;no
                  </span>
                </div>
              ...
              <div class="col-5 charges">
                <table class="table table-bordered table-sm border-danger tbl">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>CSGT <input onchange="cGst()" type="number" value="0" id="csgtp" class="bdr-none txtr">%</td>
                      <td><input type="number" value="0" id="csgt" disabled class="bdr-none txtr"></td>
                    </tr>
                    <tr>
                      <td>SGST <input onchange="sGst()" type="number" value="0" id="sgstp" class="bdr-none txtr">%</td>
...
<div>
      ...
      <footer>
        ...
        <div>
          ...
          <button class="btn btn-success" type="button" name="btn" onclick="updateQuotation();">Update Quotation</button>
        </div>
      </form>
    </footer>

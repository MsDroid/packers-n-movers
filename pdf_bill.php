						...
						<header>
							<div class="dflex">
								...
								<div class="logo-content-wrapper">
									<h1>SAFE & FAST</h1>
									<h5>A House of complete Transport Solution ( Service All over India )</h5>
									<p>E.W.S.-30, Harmu Housing Colony, Near Nigam Park, Ranchi (JH)</p>
									<p><span class="">Email : safe&fast@gmail.com</span> | <span class="">Website : www.safe&fast.com</span></p>
									<h3>Contact : 9838787323 / 8474878662</h3>
								</div>	
							</div>
						</header>
						...
						<div class="row pd10">
							...
							<div class="col-md-6 cstmfnt">
								...
								<h4>
									<table>
										<tr>
											<td><span class="mr20">Pin</span><input id="cnep0" value="<?php echo $x->consignee->cnep0; ?>" type="number" name="pin_n1" class="w30"></td>
